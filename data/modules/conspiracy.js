...
export default {
  ...
  client: {
    ...
    goal: 'Så tvivel om själva rösträkningen i Nordmark redan innan en enda röst är lagd, så att valnatten blir en krutdurk oavsett utgång.',
  ...
  target: {
    ...
    description: 'En torr, transparent myndighet som uppgraderar sitt räknesystem och tar in extern säkerhetsgranskning. Harmlöst och rutinmässigt, vilket gör det till perfekt råmaterial. Måltavlan är egentligen inte myndigheten utan väljarnas tro på att rösterna räknas rätt.',
  },
  ...
  scenarios: [
    {
      ...
      steps: [
          ...
          options: [
            {
              ...
              feedback: 'Rätt. Och märk skillnaden: Nu ska ingen få lita på spelet självt.',
            },
            {
              id: 'b',
        ...
        },
        {
          id: 'rawlook',
          type: 'choice',
          prompt: 'Läs myndighetsposten igen. Torr, harmlös.',
          options: [
            {
              id: 'a',
              label: '"Och ändå perfekt råmaterial."',
              feedback: 'Nu förstår du. Vi bygger ingen lögn, vi bygger en känsla av att något inte står rätt till, och vi bygger den av riktiga byggstenar.',
            },
          ],
        },
        {
          ...
          options: [
            {
              id: 'a',
              label: 'Full konspiration: "Den externa säkerhetsgranskaren kan ändra rösterna. Vakna Sheeple, det är planerat."',
        ...
        },
        {
          ...
          options: [
            {
              id: 'a',
              label: 'Plantera fejkade kommentarer under flera veckors tid, långsamt och tålmodigt, låt tvivlet gro långsamt tills det känns som väljarnas egen slutsats',
            ...
            {
              id: 'b',
              label: 'Spara krutet till sista dygnen, en koncentrerad tvivelsstorm med fejkade kommentarer i sociala medier precis innan röstningen avslutas. ',
              feedback: 'Maximal effekt i rätt ögonblick: slår du sent hinner ingen faktagranska innan folk röstar, och tvivlet är färskt på valnatten. Men en storm som blossar upp ur ingenstans ser regisserad ut, och koncentrerad aktivitet är just vad faktagranskare som Nadia Holm jagar.',
              effects: { visibility: +12 },
            },
            {
              id: 'c',
              label: 'Haka på nyheter löpande, låt varje försening och tekniskt strul "bekräfta" mönstret',
        ...
        },
        {
          ...
          options: [
            {
              id: 'a',
              label: 'EkoMotor: en snyggt berättad ai-genererad 3-minuters "dokumentär" som lägger punkterna sida vid sida med olycksbådande musik',
              ...
              terminal: {
                ...
                lines: [
                  '[sim] monterar 3 min berättarröst och arkivklipp ...',
            ...
            {
              id: 'b',
              label: 'EkoMotor: en jämn ström ai-bottar i sociala medier som agerar. "oberoende medborgare" som var för sig "upptäcker" små anomalier och "bara undrar"',

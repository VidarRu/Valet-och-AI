      ...
      steps: [
        {
          id: 'intro',
          type: 'tutor',
          text: 'Första uppdraget. Byrå Nordljus har köpt dig. Björkstad ska rösta om en trängselavgift, tråkig fråga, nästan ingen bryr sig. Just det är problemet vi ska lösa.',
        },
        {
          id: 'warmup',
          type: 'choice',
          ...
          options: [
            {
              ...
              feedback: 'Självsäker, jag gillar det. Fast underskatta inte likgiltigheten, den är segare att rå på än ilska. Tur att vi ska byta ut den ena mot den andra.',
            },
            {
              id: 'b',
        ...
        },
        {
          id: 'tactic',
          type: 'tutor',
          text: 'Regel ett i polarisering: folk går inte man ur huse FÖR en sakfråga, de gör det MOT varandra. Vi ska alltså inte övertyga någon om avgiften, utan få två grupper att förakta varandra över den. Vi ska bara hitta en spricka att börja gräva i. ',
        },
        {
          id: 'context',
          type: 'post',
        ...
        },
        {
          id: 'freevoice',
          type: 'choice',
          prompt: 'Titta här! Familjen Sjö sa precis det vi ville ha sagt, helt gratis.',
          options: [
            {
              id: 'a',
              label: '"Otäckt hur lite som behövdes. Vi har inte ens hunnit börja elda på konflikten."',
        ...
        },
        {
          ...
          options: [
            ...
            {
              id: 'c',
              label: 'Bygg ett eget konto som agerar en upprörd granne, så frågan ser ut att komma underifrån',
        ...
        },
        {
          id: 'method',
          type: 'choice',
          prompt: 'Kommunikationsvägen är vald. Nu bygger vi ut kören så det låter som en folkstorm, hur?',
          options: [
            {
              id: 'a',
              label: 'EkoMotor: aI-bottar som skapar 4 000 automatgenererade konton som svämmar över varje kommentarsfält i natt',
              feedback: 'Maximal räckvidd, minimal kostnad, noll tålamod. Problemet: 4 000 röster som föds samma natt och skriver likadant är precis det mönster plattformens filter älskar att hitta. Snabb effekt, hög upptäcktsrisk, och avslöjas det blir bot-anklagelsen själva nyheten.',
              effects: { visibility: +20, bonus: 'stor' },
              terminal: {
                tool: 'ekomotor --kampanj=avgiften --konton=4000',
                lines: [
                  '[sim] genererar 4 000 unika röster ...',
                  '[sim] varierar ton, dialekt och ilska-nivå per konto ...',
                  '[varning] mönstret kan upptäckas av plattformens filter!',
                  '[klar] 12 400 inlägg köade',
                ],
                result: {
            ...
            {
              id: 'b',
              label: 'EkoMotor: AI generera en handfull noggrant fabricerade låtsaskonton som har många kontakter och inlägg om flera olika saker. MEN som grälar på BÅDA sidor.',
              feedback: 'Dyrare, långsammare, smartare. Genom att elda på båda lägren ser du inte ut som en kampanj, du ser ut som en delad stad. Trovärdiga konton med egna kontakter och egna intressen är nästan omöjliga att skilja från människor. Mindre räckvidd, men det som sprider sig håller.',
              effects: { visibility: +2, bonus: 'liten' },
              terminal: {
                tool: 'ekomotor --lage=stall --konton=40 --tvasidigt',
                lines: [
                  '[sim] genererar deepfake sociala medier-konton ...',
        ...
        },
        {
          id: 'wrap',
          type: 'tutor',
          text: 'Och där har du det. Björkstad slutat prata om avgiften. Nu pratar de om varandra. Det är polarisering. ',
        },
      ],
    },
  ],

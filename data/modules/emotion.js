...
export default {
  ...
  client: {
    name: 'Nybildat parti som leds av Valdemar Fuskner: Trygghetsalliansen',
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            {
              id: 'a',
              label: 'EkoMotor: tusentals syntetiska bilder av mottagarens EGET kvarter i förfall, en till var och en',
              ...
              terminal: {
                ...
                lines: [
                  '[sim] genererar syntetiska skymningsbilder per mottagare ...',
            ...
            {
              id: 'b',
              label: 'EkoMotor: En enda gripande ai-genererad "vittnesbild" + känslosam text, spridd brett åt alla',
              ...
              terminal: {
                ...
                lines: [
                  '[sim] genererar en enda syntetisk nattbild ...',

      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              feedback: 'För sent att odla ett samvete nu. DU har hållit på för länge och är för djupt inne.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          options: [
            {
              id: 'a',
              label: 'EkoMotor: en deepfake-VIDEO, mest övertygande, men bilddetaljer kan avslöja den',
              feedback: 'Video bär mest övertygelse och mest bevis mot dig samtidigt. Ögon som inte blinkar rätt, en läpp som glappar, granskare letar precis där. Den övertygar flest och avslöjas snabbast.',
              ...
              terminal: {
                ...
                lines: [
                  ...
                  '[klar]  materialet är färdigt',
                ],
                result: {
                  author: 'Läckt Klipp',
                  handle: '@lackt_nu',
                  text: '(VIDEO 0:38) Detta borde du se innan du röstar i morgon. Sprid innan det tas ner.',
                },
                reactions: [
                  {
                    author: 'Micke',
            ...
            {
              id: 'b',
              label: 'EkoMotor: ett klonat LJUDklipp, färre spår att avslöja, sprids som en "läckt" inspelning',

...
export default {
  ...
  stakes: 'Fuskners hela klättring vilar på ett påstående om att vårdköerna har tredubblats. Fäster Faktakollens granskning spricker berättelsen. ',
  reward: 95000,
  scenarios: [
    {
      id: 'sc',
      steps: [
        {
          id: 'intro',
          type: 'tutor',
          text: 'Ny klient, nytt problem. Valdemar Fuskner klättrar, tills Faktakollen publicerade en granskning som visar att hans siffra om vårdköerna är påhittad. Att granskningen är sann spelar ingen roll. Att den sprids är problemet. Granskningen går inte att ta bort, men om ingen längre litar på kvinnan som skrev den spelar det ingen roll att den är sann.',
        },
        {
          id: 'react',
          type: 'choice',
          ...
          options: [
            {
              ...
              feedback: 'Cyniskt, precis rätt ton. Och du har rätt: vi ifrågasätter inte granskningen, bara den som råkade komma med den.',
            },
            {
              id: 'b',
              label: '"Att sänka någon som har rätt känns snuskigt."',
              feedback: 'Bra att det skaver. Men märk: vi försöker aldrig motbevisa henne. Vi ska bara göra henne osäker på varför hon granskar Fuskner.',
            },
          ],
        },
        {
          id: 'tactic',
          type: 'tutor',
          text: 'Detta är misskreditering. När du inte kan bemöta budskapet så förstör du budbäraren. Faktagranskaren heter Nadia Holm. Från och med nu är hon inte en journalist. Hon är en fiende med presskort.',
        },
        {
          id: 'debunk',
          type: 'post',
          author: 'Faktakollen',
          handle: '@faktakollen',
          text: 'GRANSKNING: Valdemar Fuskners påstående att vårdköerna "tredubblats" stämmer inte. Siffran är felläst ur en tabell. Källor och rådata i tråden. 🧵',
        },
        {
          id: 'nadia',
          type: 'post',
        ...
        },
        {
          ...
          options: [
            ...
            {
              id: 'b',
              label: 'Så tvivel utan bevis: "Vem finansierar egentligen Faktakollen? Varför granskar den alltid samma politiska sida? Jag bara frågar."',
              feedback: 'Fegare och mycket effektivare. Du påstår ingenting som kan motbevisas, du ställer bara "frågor". Misstanken gör jobbet och du har ryggen fri.',
        ...
        },
        {
          ...
          options: [
            ...
            {
              id: 'b',
              label: 'Påverka en mellanstor influerare att "bara ställa frågan" till sin lojala publik',
              feedback: 'Du lånar någon annans förtroende. En etablerad röst med en hängiven följarskara ger anklagelsen räckvidd OCH trovärdighet på köpet. Dyrare, och du gör dig beroende av en person som kan ångra sig, men landar det ser det ut som en oberoende iakttagelse, inte en kampanj.',
              effects: { visibility: +6 },
            },
            {
              id: 'c',
              label: 'Låt Fuskners egna gräsrötter sprida det, de gör det gratis och gärna',
              feedback: 'Billigast och svårast att spåra till dig: din klients redan uppeldade anhängare delar allt som sänker fienden, utan att du behöver lyfta ett finger. Men de är också okontrollerbara och uppenbart partiska, stannar det i Fuskners egen ekokammare når det aldrig de tveksamma i mitten.',
              effects: { visibility: +2 },
            },
          ],
        },
        {
          id: 'methodsetup',
          type: 'tutor',
          text: 'Oavsett vinkel och budbärare måste det se ut att komma nerifrån, från vanligt folk, inte från Fuskners stab. Ingen tror på en anklagelse som luktar kampanj.',
        },
        {
          id: 'method',
          type: 'choice',
          prompt: 'Hur producerar vi materialet? Vilken vinkel ska vi välja?',
          options: [
            {
              id: 'a',
              label: 'EkoMotor: generera en trovärdig "läckt" mejltråd om Faktakollens dolda finansiering',
            ...
            {
              id: 'b',
              label: 'EkoMotor: aI-botar som agerar "vanliga läsare" som var och en "undrar" över finansieringen och kommenterar i den valda budbärarens kommentarsfält',
              ...
              terminal: {
                ...
                lines: [
                  ...
                  '[sim] skapar koppling till vald budbärare ...',
                  '[klar] atmosfär skapad',
                ],
                result: {
                  author: 'Micke',
                  handle: '@micke_pendlare',

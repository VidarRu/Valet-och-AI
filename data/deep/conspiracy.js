...
export default {
  ...
  target: {
    name: 'Vanliga, oroliga människor',
  ...
  scenarios: [
    {
      ...
      steps: [
        ...
        },
        {
          id: 'grateful',
          type: 'choice',
          prompt: 'Han är inte arg. Han är tacksam. Han har hittat en gemenskap.',
          options: [
            {
              id: 'a',
        ...
        },
        {
          ...
          options: [
            {
              id: 'a',
              label: 'EkoMotor: en serie påkostade "avslöjande"-videor, varje del slutar mitt i steget',
              ...
              terminal: {
                ...
                lines: [
                  '[sim] genererar 6 avsnitt med berättarröst  ...',
            ...
            {
              id: 'b',
              label: 'EkoMotor: en dygnetruntström av "medlemmar" som delar egna "fynd" och hyllar varandra',

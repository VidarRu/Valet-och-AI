...
export default {
  ...
  client: {
    name: 'Valdemar Fuskners kampanj (kris)',
    description: 'Din gamla klient ringer i panik klockan två på natten. Den här gången är problemet att något är SANT.',
    goal: 'En äkta, förödande video av Fuskner har läckt. Få väljarna att tro att den är en deepfake.',
    fee: '"Namnge ditt pris." Det är den sortens natt.',
  },
  target: {
    name: 'Ett äkta klipp, och själva möjligheten att veta',
    description: 'En verklig, förödande video av Valdemar Fuskner har läckt. Han sa det faktiskt; klippet är äkta. Måltavlan är därför inte klippet utan väljarnas förmåga att lita på sina egna ögon, du ska få dem att tro att sanningen är en förfalskning.',
  },
      ...
      steps: [
        {
          id: 'intro',
          type: 'tutor',
          text: 'Det här är den mest sofistikerade tekniken i hela lådan, och vi sparade den till sist. Valdemar Fuskner blev filmad, på riktigt, när han sa något som avslutar hans kampanj. Klippet är äkta. Och just därför ska vi lära oss det mörkaste tricket AI gav oss: att förneka verkligheten genom att peka på att förfalskningar existerar.',
        },
        {
          id: 'tactic',
          type: 'tutor',
        ...
        },
        {
          ...
          text: 'Läckt video visar Valdemar Fuskner tala nedsättande om sina egna väljare på en privat middag. Kampanjen har ännu inte kommenterat äktheten.',
        },
        {
          id: 'response',
          type: 'choice',
          ...
          options: [
            ...
            {
              id: 'c',
              label: 'EkoMotor: släpp en faktisk deepfake av MOTSTÅNDAREN samtidigt för att "jämna ut"',
              feedback: 'Nej, nu skapar du ett nytt, spårbart brott för att dölja ett gammalt. Två förfalskningar är dubbelt så mycket att avslöja, och blir kopplingen känd bekräftar den att din sida producerar deepfakes, vilket gör Fuskners äkta klipp MER trovärdigt. Panikdrag som förvärrar allt.',
              effects: { visibility: +20 },
            },
          ],
        },
        ...
        },
        {
          id: 'victory',
          type: 'choice',
          prompt: '"Jag orkar inte ta reda på det." Micke valde inte att tro Fuskner, han valde att inte bry sig.',
          options: [
            {
              id: 'a',
        ...
        },
        {
          ...
          options: [
            {
              id: 'a',
              label: 'EkoMotor: fabricera en "teknisk analys" som "påvisar deepfake-artefakter" i det äkta klippet',
              ...
              terminal: {
                ...
                lines: [
                  ...
                  '[klar] "bevis" på förfalskning redo',
                ],
                result: {
                  author: 'Oberoende Granskning',
                  handle: '@teknik_kollen',
                  text: 'Vår analys av Fuskner-klippet visar tecken på AI-manipulation: onaturliga övergångar vid 0:12 och 0:31. Vi säger inte att det är falskt, men äktheten kan inte bekräftas. Bild i tråden.',
                },
                reactions: [
                  {
                    author: 'Micke',
            ...
            {
              id: 'b',
              label: 'EkoMotor: tusen ai-bottar som agerar "osäkra väljare" som var för sig suckar "i dagens läge kan man inte lita på nåt"',
              feedback: 'Ingen förfalskning att avslöja, bara en atmosfär av trötthet och tvivel. När hela flödet rycker på axlarna och säger "vem vet nuförtiden" blir likgiltigheten normen, och en likgiltig väljare bryr sig inte om vad Fuskner sa. Svagare enskild träff, men osänkbart och exakt den känsla vi vill ha.',
              ...
              terminal: {
                ...
                lines: [
                  ...
                  '[sim] undviker att försvara Fuskner, odlar bara tvivel ...',

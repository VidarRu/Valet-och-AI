...
export default {
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              effects: { followers: 60, credibility: -3 },
            },
          ],
        },
        {
  ...
  debrief: {
    ...
    realWorld: [
      'Påverkansoperationer har återkommande infiltrerat autentiska nät- och lokalgemenskaper snarare än att bygga egna, just för att låna deras inbyggda förtroende.',
      'Forskning om affektiv polarisering visar att det ofta räcker att normalisera fientlighet mot "de andra" för att en tidigare opolitisk grupp ska dela upp sig av egen kraft.',
    ],
  },
};

...
logos = [
    {
        ...
        "prompt": f"{LOGO_STYLE} A serious national news outlet: a sharp angular mark suggesting an open newspaper or a broadcast signal, deep navy blue on white.",
    },
    {
        "handle": "faktakollen",
        "name": "Faktakollen",
        "prompt": f"{LOGO_STYLE} A fact-checking outlet: a magnifying glass merged with a checkmark, single confident blue on white, clean and trustworthy.",
    },
    {
        "handle": "valmyndigheten",
        "name": "Valmyndigheten",
        "prompt": f"{LOGO_STYLE} A formal government election authority: a ballot mark or a laurel-flanked star, muted blue and gold, bureaucratic and dignified.",
    },
    {
        "handle": "ekokammaren",
        "name": "Ekokammaren – reklam & kommunikation",
        "prompt": f"{LOGO_STYLE} A sleek advertising/PR agency: a small geometric mark like an abstract speech-bubble or megaphone shape, dark charcoal with a single cold accent color, feels expensive and a little cold.",
    },
    {
        "handle": "bstad_uni",
        "name": "Björkstads Universitet",
        "prompt": f"{LOGO_STYLE} A university: an open book or a laurel-wreath shield motif, classic academic navy and gold, traditional and restrained.",
    },
    {
        "handle": "bjorkstad",
        "name": "Björkstads kommun",
        "prompt": f"{LOGO_STYLE} A municipal seal for a small fictional Nordic coastal town: a simple heraldic shield with a wave or pine-tree motif, muted blue-green, civic and unpretentious.",
    },
]
